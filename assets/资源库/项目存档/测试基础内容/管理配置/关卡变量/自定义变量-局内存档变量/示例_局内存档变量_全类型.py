...
VARIABLE_FILE_ID = "sample_ingame_save_variables_all_types__测试基础内容"
VARIABLE_FILE_NAME = "示例_局内存档变量_全类型"


LEVEL_VARIABLES: list[LevelVariableDefinition] = [
    LevelVariableDefinition(
        variable_id="var_sample_player_1_chip_1__测试基础内容",
    ...
    LevelVariableDefinition(
        variable_id="var_sample_player_1_chip_2__测试基础内容",
    ...
    LevelVariableDefinition(
        variable_id="var_sample_player_1_chip_3__测试基础内容",
    ...
    LevelVariableDefinition(
        variable_id="var_sample_player_1_chip_4__测试基础内容",
    ...
    LevelVariableDefinition(
        variable_id="var_sample_player_1_chip_5__测试基础内容",
    ...
    LevelVariableDefinition(
        variable_id="var_sample_player_1_chip_6__测试基础内容",
