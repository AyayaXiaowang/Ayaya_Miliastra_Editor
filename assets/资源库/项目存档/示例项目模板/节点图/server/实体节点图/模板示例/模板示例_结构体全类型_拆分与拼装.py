...
class 模板示例_结构体全类型_拆分与拼装:
    ...
    def on_自定义变量变化时(
        ...
        实体字段当前值_修改前: "实体" = 实体字段_修改前
        GUID字段当前值_修改前: "GUID" = GUID字段_修改前
        整数字段当前值_修改前: "整数" = 整数字段_修改前
        布尔值字段当前值_修改前: "布尔值" = 布尔值字段_修改前
        浮点数字段当前值_修改前: "浮点数" = 浮点数字段_修改前
        字符串字段当前值_修改前: "字符串" = 字符串字段_修改前
        当前整数字段值: "整数" = 整数字段当前值_修改前
        新整数字段值: "整数" = 当前整数字段值 + 1
        ...
        实体字段当前值_修改后: "实体" = 实体字段_修改后
        GUID字段当前值_修改后: "GUID" = GUID字段_修改后
        整数字段当前值_修改后: "整数" = 整数字段_修改后
        布尔值字段当前值_修改后: "布尔值" = 布尔值字段_修改后
        浮点数字段当前值_修改后: "浮点数" = 浮点数字段_修改后
        字符串字段当前值_修改后: "字符串" = 字符串字段_修改后
        最新整数字段值: "整数" = 整数字段当前值_修改后
