...
STRUCT_PAYLOAD: Dict[str, Any] = {
    ...
    "fields": [
        ...
        },
        {
            "field_name": "整数列表字段",
            "param_type": "整数列表",
            "default_value": {"param_type": "整数列表", "value": ["1", "2", "3"]},
        },
        {
            "field_name": "布尔值列表字段",
            "param_type": "布尔值列表",
            "default_value": {"param_type": "布尔值列表", "value": ["True", "False"]},
        },
        {
            "field_name": "浮点数列表字段",
            "param_type": "浮点数列表",
            "default_value": {"param_type": "浮点数列表", "value": ["1.0", "2.5"]},
        },
        {
            "field_name": "字符串列表字段",
            "param_type": "字符串列表",
            "default_value": {"param_type": "字符串列表", "value": ["条目1", "条目2", "条目3"]},
        },
        {
            "field_name": "阵营列表字段",
            "param_type": "阵营列表",
            "default_value": {"param_type": "阵营列表", "value": ["0", "1"]},
        },
        {
            "field_name": "三维向量列表字段",
            "param_type": "三维向量列表",
        ...
        },
        {
            "field_name": "元件ID列表字段",
            "param_type": "元件ID列表",
            "default_value": {"param_type": "元件ID列表", "value": ["0", "1"]},
        },
        {
            "field_name": "配置ID列表字段",
            "param_type": "配置ID列表",
            "default_value": {"param_type": "配置ID列表", "value": ["0", "1"]},
        },
        {
            "field_name": "结构体列表字段",
            "param_type": "结构体列表",
