...
- `test_execute_config_node_merged_regular_param_port_gap_integration.py`：轻量集成回归 `execute_config_node_merged`：普通参数必须走“端口间距法”输入，不应调用 `handle_regular_param_fallback`。
