...
用法（在项目根目录运行）：
  python tools/validate_graph_cache_integrity.py                # 扫描 app/runtime/cache/graph_cache 下所有 .json
  python tools/validate_graph_cache_integrity.py path/to/file.json [more.json ...]
  python tools/validate_graph_cache_integrity.py app/runtime/cache/graph_cache
"""
