...
from app.ui.panels.combat.combat_ability_components import CombatSettingsSection
from app.ui.panels.template_instance.graphs_tab import GraphsTab
from app.ui.panels.combat.combat_player_panel_sections_custom_variables import (
    CombatPlayerPanelSectionsCustomVariablesMixin,
)
from app.ui.panels.combat.combat_player_panel_sections_graphs import (
    CombatPlayerPanelSectionsGraphsMixin,
)
from app.ui.panels.combat.combat_player_panel_sections_ingame_save import (
    CombatPlayerPanelSectionsIngameSaveMixin,
)
from app.ui.panels.combat.combat_player_panel_sections_player_fields import (
    CombatPlayerPanelSectionsPlayerFieldsMixin,
)
from app.ui.panels.combat.combat_player_panel_sections_role_fields import (
    CombatPlayerPanelSectionsRoleFieldsMixin,
)
from app.ui.panels.combat.combat_player_panel_sections_types import (
    _GraphBindingContext,
    _PlayerEditorStruct,
)
from app.ui.panels.combat.combat_player_panel_sections_ui import (
