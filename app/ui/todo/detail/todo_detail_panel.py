...
from app.ui.todo.misc.todo_config import TodoStyles, LayoutConstants
...
from app.ui.todo.detail.todo_detail_adapter import TodoDetailAdapter
from app.ui.todo.list.todo_widgets import create_execute_button
...
class TodoDetailView(QtWidgets.QWidget):
    ...
    def _render_block(self, block: object, layout: QtWidgets.QVBoxLayout) -> None:
        from app.ui.todo.detail.todo_detail_model import (
            BulletListBlock,
            CollapsibleBlock,
            ParagraphBlock,
            ParagraphStyle,
