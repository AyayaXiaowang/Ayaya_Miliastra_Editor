...
from app.ui.todo.tree.todo_event_flow_blocks import (
    build_event_flow_block_groups,
    collect_block_node_ids_for_header_item,
    create_block_header_item,
)
from app.ui.todo.tree.todo_tree_graph_expander import expand_graph_on_demand
...
class TodoTreeLazyMixin:
    ...
    def _expand_event_flow_children_on_demand(
        ...
        *,
        ...
        from app.ui.todo.tree.todo_event_flow_blocks import EventFlowBlockGroup
